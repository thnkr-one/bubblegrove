...
ActiveRecord::Schema[7.2].define(version: 2024_10_28_103826) do
  ...
  create_table "thnk_products", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["handle"], name: "index_thnk_products_on_handle", unique: true
    t.index ["uuid"], name: "index_thnk_products_on_uuid", unique: true
  end

  create_table "thnk_variants", force: :cascade do |t|
    t.uuid "thnk_product_id", null: false
    ...
    t.datetime "updated_at", null: false
    t.uuid "uuid"
    t.index ["thnk_product_id"], name: "index_thnk_variants_on_thnk_product_id"
    t.index ["variant_sku"], name: "index_thnk_variants_on_variant_sku", unique: true
  end

  add_foreign_key "active_storage_attachments", "active_storage_blobs", column: "blob_id"
  add_foreign_key "active_storage_variant_records", "active_storage_blobs", column: "blob_id"
  add_foreign_key "thnk_variants", "thnk_products"
end
